    ...
    <nav className="font-ecotruck w-full fixed top-0 left-0 flex items-center px-4 md:px-8 py-2 bg-white shadow-lg z-50 border-b border-gray-200 justify-between">
      ...
      <div className="hidden md:flex flex-row items-center gap-8">
        ...
        <div className="flex flex-row gap-2">
          <Link to="/login">
            <button className="bg-green-600 text-white px-4 py-2 rounded-2xl transition-transform duration-200 hover:scale-110 text-base">Inicia sesión</button>
          </Link>
          <Link to="/register">
          ...
          <div className="w-3/4 max-w-xs bg-white h-full shadow-lg p-6 flex flex-col">
            ...
            <div className="flex flex-col gap-2">
              <Link to="/login" onClick={() => setMenuOpen(false)}>
                <button className="bg-green-600 text-white px-4 py-2 rounded-2xl transition-transform duration-200 hover:scale-110 text-base w-full">Inicia sesión</button>
              </Link>
